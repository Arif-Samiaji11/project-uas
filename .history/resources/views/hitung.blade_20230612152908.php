            ...
            <tbody>
                ...
                <tbody>
                    <tr>
                            {{-- hasil --}}
                            <td>
                                {{(($lokasii->alamat / $C1max['lokasii'])*$widget1['kriterias'])+
                                (($lokasii->luas_lahan / $C2max['lokasii'])*$widget2['kriterias'])+
                                (($lokasii->luas_bangunan / $C3max['lokasii'])*$widget3['kriterias'])+
                                (($lokasii->daya_listrik / $C4max['lokasii'])*$widget4['kriterias'])+
                                }}
                            </td>
