            ...
            <div class="card card-info">
              ...
              <form method="POST" action="{{ url('/kriteriaa/store')}}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <!-- <div class="form-group row">
                    <label for="lokasialternatif" class="col-sm-2 col-form-label">Lokasialternatif</label>
                    <div class="col-sm-10">
                  ...
                  <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="kriteriaa" placeholder="kriteriaa">
                    </div>
                  </div> -->
                </div>
                <!-- /.card-body -->
