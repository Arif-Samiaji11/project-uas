            ...
            <div class="card card-info">
              ...
              <form method="POST" action="{{ url('/lokasi/update/'.$lokasi->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="luas_bangunan" class="col-sm-2 col-form-label">Bobot</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="luas_bangunan" placeholder="luas_bangunan" value="{{ $lokasi->luas_bangunan}}">
                    </div>
                  </div>
                  <div class="form-group row">
