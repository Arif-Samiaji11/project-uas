              ...
              <form method="POST" action="{{ url('/kriteriaa/update/'.$kriteriaa->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                    <label for="jenis" class="col-sm-2 col-form-label">DAYA LISTRIK</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="jenis" placeholder="daya listrik" value="{{ $kriteria->jenis}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
