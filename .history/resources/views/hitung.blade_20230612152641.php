            ...
            <tbody>
                ...
                <tbody>
                    <tr>
                            ...
                            <td>{{$lokasii->ALAMAT / $max['lokasii']}}</td>
                            <td>{{$lokasii->LUAS LAHAN / $C2max['lokasii']}}</td>
                            <td>{{$lokasii->LUAS BANGUNAN / $C3max['lokasii']}}</td>
                            <td>{{$lokasii->DAYA LISTRIK / $C4max['lokasii']}}</td>
