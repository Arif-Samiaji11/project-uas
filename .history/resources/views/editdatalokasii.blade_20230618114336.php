              ...
              <form method="POST" action="{{ url('/lokasi/update/'.$lokasi->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label for="alamat" class="col-sm-2 col-form-label">Lokasi Alternatif</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="alamat" placeholder="lokasi alternatif" value="{{ $lokasi->alamat}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="kriteria" class="col-sm-2 col-form-label">Kriteria</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="kriteria" placeholder="kriteria" value="{{ $lokasi->kriteria}}">
                    </div>
                  </div>
                  <div class="form-group row">
