            ...
            <div class="card card-info">
              ...
              <form method="POST" action="{{ url('/lokasi/update/'.$lokasi->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="daya_listrik" class="col-sm-2 col-form-label">DAYA LIST</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="daya_listrik" placeholder="daya_listrik" value="{{ $lokasi->daya_listrik}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
