            ...
            <tbody>
                ...
                <tbody>
                    <tr>
                            ...
                            <td>{{$item->nama }}</td>
                            <td>{{$item->C1 / $C1max['lokasii']}}</td>
                            <td>{{$item->C2 / $C2max['lokasii']}}</td>
                            <td>{{$item->C3 / $C3max['lokasii']}}</td>
                            <td>{{$item->C4 / $C4max['lokasii']}}</td>
                            <td>{{$item->C5 / $C5max['lokasii']}}</td>
                ...
                <tbody>
                    <tr>
                        <td>{{$item->nama}}</td>
                            {{-- hasil --}}
                            <td>
                                {{(($item->C1 / $C1max['lokasii'])*$widget1['kriterias'])+
                                (($item->C2 / $C2max['lokasii'])*$widget2['kriterias'])+
                                (($item->C3 / $C3max['lokasii'])*$widget3['kriterias'])+
                                (($item->C4 / $C4max['lokasii'])*$widget4['kriterias'])+
                                (($item->C5 / $C5max['lokasii'])*$widget5['kriterias'])}}
                            </td>
