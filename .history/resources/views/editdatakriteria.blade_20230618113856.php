              ...
              <form method="POST" action="{{ url('/kriteriaa/update/'.$kriteriaa->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    <label for="lokasial" class="col-sm-2 col-form-label">ALAMAT</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="lokasial" placeholder="lokasial" value="{{ $kriteria->lokasial}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="luas_lahan" class="col-sm-2 col-form-label">LUAS LAHAN</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="luas_lahan" placeholder="luas lahan" value="{{ $kriteria->luas_lahan}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="luas_bangunan" class="col-sm-2 col-form-label">LUAS BANGUNAN</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="luas_bangunan" placeholder="luas bangunan" value="{{ $kriteria->luas_bangunan}}">
                    </div>
                    </div>
                    <div class="form-group row">
                    <label for="daya_listrik" class="col-sm-2 col-form-label">DAYA LISTRIK</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="daya_listrik" placeholder="daya listrik" value="{{ $kriteria->daya_listrik}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
