...
Route::get('/datakriteriaa', function () {
    return view('datakriteriaa');
});

use App\Http\Controllers\kriteriaaController;
Route::controller(kriteriaaController::class)->group(function() {
